/**
 * `CSLKPCDY` — the lookup tables the account update edits use: North American
 * general purpose area codes, US state codes, and the state + first two zip
 * digit combinations.
 */

/** `VALID-GENERAL-PURP-CODE`. */
export const generalPurposeAreaCodes: ReadonlySet<string> = new Set([
...
/** `VALID-US-STATE-CODE`. */
export const usStateCodes: ReadonlySet<string> = new Set([
...
export const usStateZipCombinations: ReadonlySet<string> = new Set([
