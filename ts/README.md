...
| `@carddemo/posting` | `CBTRN01C`, `CBTRN02C` | Daily transaction validation/read and daily transaction posting: xref and account lookups, credit limit and expiry validation, rejects with their reason codes, transaction master writes, account balance and cycle credit/debit updates, category balance updates, `carddemo-posting` CLI |
