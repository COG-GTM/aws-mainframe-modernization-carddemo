...
| `@carddemo/online-usradmin` | `COUSR00C`, `COUSR01C`, `COUSR02C`, `COUSR03C` | User administration transactions as typed screen handlers over `USRSEC`, plus a thin Express transport |
