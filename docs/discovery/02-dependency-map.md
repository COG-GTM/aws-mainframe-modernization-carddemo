...
| CBIMPORT | STEP01 | `app/jcl/CBIMPORT.jcl:22` | CBIMPORT [application] |  |  | CVACT01Y, CVACT02Y, CVACT03Y, CVCUS01Y, CVEXPORT, CVTRA05Y | AWS.M2.CARDDEMO.EXPORT.DATA (read)<br>AWS.M2.CARDDEMO.CUSTDATA.IMPORT (write)<br>AWS.M2.CARDDEMO.ACCTDATA.IMPORT (write)<br>AWS.M2.CARDDEMO.CARDXREF.IMPORT (write)<br>AWS.M2.CARDDEMO.TRANSACT.IMPORT (write)<br>AWS.M2.CARDDEMO.IMPORT.ERRORS (write) |
...
| AWS.M2.CARDDEMO.ACCTDATA.IMPORT | sequential |  | CBIMPORT: write `app/cbl/CBIMPORT.cbl:48` | application program, JCL DD/control statement |
...
| AWS.M2.CARDDEMO.CARDXREF.IMPORT | sequential |  | CBIMPORT: write `app/cbl/CBIMPORT.cbl:53` | application program, JCL DD/control statement |
...
| AWS.M2.CARDDEMO.CUSTDATA.IMPORT | sequential |  | CBIMPORT: write `app/cbl/CBIMPORT.cbl:43` | application program, JCL DD/control statement |
...
| AWS.M2.CARDDEMO.TRANSACT.IMPORT | sequential |  | CBIMPORT: write `app/cbl/CBIMPORT.cbl:58` | application program, JCL DD/control statement |
