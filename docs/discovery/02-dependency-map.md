...
| COMEN01C | COCRDLIC | dynamic | resolved | `app/cbl/COMEN01C.cbl:156` | EXEC CICS XCTL dynamic (table-driven: VALUE literal in app/cpy/COMEN02Y.cpy) |
| COMEN01C | COCRDSLC | dynamic | resolved | `app/cbl/COMEN01C.cbl:156` | EXEC CICS XCTL dynamic (table-driven: VALUE literal in app/cpy/COMEN02Y.cpy) |
| COMEN01C | COCRDUPC | dynamic | resolved | `app/cbl/COMEN01C.cbl:156` | EXEC CICS XCTL dynamic (table-driven: VALUE literal in app/cpy/COMEN02Y.cpy) |
| COMEN01C | COPAUS0C | dynamic | resolved | `app/cbl/COMEN01C.cbl:156` | EXEC CICS XCTL dynamic (table-driven: VALUE literal in app/cpy/COMEN02Y.cpy) |
| COMEN01C | CORPT00C | dynamic | resolved | `app/cbl/COMEN01C.cbl:156` | EXEC CICS XCTL dynamic (table-driven: VALUE literal in app/cpy/COMEN02Y.cpy) |
